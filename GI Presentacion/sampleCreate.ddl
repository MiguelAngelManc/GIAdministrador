...
CREATE TABLE clientes (IdCliente INTEGER AUTO_INCREMENT NOT NULL, Correo VARCHAR(50) NOT NULL, DirCP INTEGER NOT NULL, DirCalle VARCHAR(50) NOT NULL, DirColonia VARCHAR(50) NOT NULL, DirEntre VARCHAR(50) NOT NULL, DirExt INTEGER NOT NULL, DirInt INTEGER NOT NULL, Nombre VARCHAR(50) NOT NULL, Telefono VARCHAR(50) NOT NULL, PRIMARY KEY (IdCliente))
...
CREATE TABLE productos (IdProducto INTEGER AUTO_INCREMENT NOT NULL, Clasificacion VARCHAR(50) NOT NULL, Contenido VARCHAR(255), Nombre VARCHAR(50) NOT NULL, Precio FLOAT NOT NULL, PRIMARY KEY (IdProducto))
